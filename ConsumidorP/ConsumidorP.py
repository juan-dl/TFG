#Se importan las funciones para comunicarse con la cola (pika), junto con los modulos 'time' y 'random' para poder incluir el retardo durante la recepción de los mensajes
#Por último se importan las funciones para poder manejar los tiempos
...
#Simula la recepción y procesamiento de una petición
def callback(ch, method, properties, body):
    fibo(20)
    #Se crea un retardo aleatorio
    time.sleep(random.uniform(0.0, 1.0))
    #Se imprime un mensaje a modo de log
    print("Mensaje Recibido " + str(body)[2:10])
   
    #Se envia un ack para confirmar la consumición del mensaje y que se pueda recibir otro
